...
export const AI_MODELS = {
  ...
  cloudflareHappyHorseI2V: { id: "cloudflare/alibaba/hh1.1-i2v", provider: "cloudflare", label: "HappyHorse 1.1 I2V", shortLabel: "Cloudflare · HappyHorse I2V", modality: "video", contextTokens: 0, maxOutputTokens: 0 },
